...
train_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/root/Nick/Genioos/synthesize_images/dataset_height_further/train_annotations.json',
        backend_args=None,
        data_prefix=dict(img='/root/Nick/Genioos/synthesize_images/dataset_height_further/images/train_jpg/'),
        data_root='/root/Nick/Genioos/synthesize_images/dataset_height_further/',
...
val_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='/root/Nick/Genioos/synthesize_images/dataset_height_further/validation_annotations.json',
        backend_args=None,
        data_prefix=dict(img='/root/Nick/Genioos/synthesize_images/dataset_height_further/images/val_jpg/'),
        data_root='/root/Nick/Genioos/synthesize_images/dataset_height_further/',
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
            dict(keep_ratio=True, scale=(
